...
int main()
{
    const vector<size_t> vector_lengths = { 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 25000, 50000, 100000 };
     ...
     for (size_t length : vector_lengths) {
         ...
         quick_random_stats_file.open("C://Users/Роллсройсилиройсролс/source/repos/SortingC++(Lab3)/quick_random_stats_file.txt", ios::app | ios::out);
         quick_random_stats_file << quick_random_mean_stats;
         quick_random_stats_file.close();

         ofstream merge_random_stats_file;
         merge_random_stats_file.open("C://Users/Роллсройсилиройсролс/source/repos/SortingC++(Lab3)/merge_random_stats_file.txt", ios::app | ios::out);
         merge_random_stats_file << merge_random_mean_stats;
         merge_random_stats_file.close();

         ofstream selection_sorted_stats_file;
         selection_sorted_stats_file.open("C://Users/Роллсройсилиройсролс/source/repos/SortingC++(Lab3)/selection_sorted_stats_file.txt", ios::app | ios::out);
         selection_sorted_stats_file << selection_sorted_stats;
         selection_sorted_stats_file.close();

         ofstream quick_sorted_stats_file;
         quick_sorted_stats_file.open("C://Users/Роллсройсилиройсролс/source/repos/SortingC++(Lab3)/quick_sorted_stats_file.txt", ios::app | ios::out);
         quick_sorted_stats_file << quick_sorted_stats;
         quick_sorted_stats_file.close();

         ofstream merge_sorted_stats_file;
         merge_sorted_stats_file.open("C://Users/Роллсройсилиройсролс/source/repos/SortingC++(Lab3)/merge_sorted_stats_file.txt", ios::app | ios::out);
         merge_sorted_stats_file << merge_sorted_stats;
         merge_sorted_stats_file.close();

         ofstream selection_reverse_sorted_stats_file;
         selection_reverse_sorted_stats_file.open("C://Users/Роллсройсилиройсролс/source/repos/SortingC++(Lab3)/selection_reverse_sorted_stats_file.txt", ios::app | ios::out);
         ...
         quick_reverse_sorted_stats_file.open("C://Users/Роллсройсилиройсролс/source/repos/SortingC++(Lab3)/quick_reverse_sorted_stats_file.txt", ios::app | ios::out);
         ...
         merge_reverse_sorted_stats_file.open("C://Users/Роллсройсилиройсролс/source/repos/SortingC++(Lab3)/merge_reverse_sorted_stats_file.txt", ios::app | ios::out);
